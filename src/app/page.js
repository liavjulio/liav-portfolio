  ...
  const workExperience = [
    {
      ...
      period: '2017 – 2020',
      description: 'Led and trained combat units in high-stress environments, developed leadership skills, and managed strategic mission planning.'
    },
    {
    ...
    <div className="bg-[#0D1117] text-white font-sans scroll-smooth">
      ...
      <nav className="w-full sticky top-0 z-50 bg-[#0D1117] border-b border-gray-800 py-4">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="space-x-6 text-gray-300 text-sm">
            ...
            <Link href="/LiavHuliCV.pdf" className="hover:text-blue-400">CV</Link>
          </div>
        </div>
      </nav>
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <div className="mt-8 flex justify-center gap-4 flex-wrap">
          <a href="https://github.com/liavjulio" className="bg-gray-800 hover:bg-gray-700 px-5 py-2 rounded-md text-sm flex items-center gap-2">
            <FaGithub /> GitHub
          </a>
          <a href="https://www.linkedin.com/in/liav-huli-software-cpp-c-html-javascript-css-java/" className="bg-blue-600 hover:bg-blue-500 px-5 py-2 rounded-md text-sm flex items-center gap-2">
            <FaLinkedin /> LinkedIn
          </a>
          <Link href="#projects" className="bg-white text-black hover:bg-gray-200 px-5 py-2 rounded-md text-sm">
            View Projects
          </Link>
        </div>

        <div className="flex justify-center gap-4 mt-10 text-2xl text-gray-400">
          <SiJavascript /> <SiTypescript /> <FaReact /> <FaNodeJs /> <FaDocker /> <FaAws /> <SiMongodb /> <SiPostgresql />
        </div>
      </section>
...
<section id="skills" className="max-w-6xl mx-auto px-6 py-20">
  ...
  <p className="text-center text-gray-400 mb-12">
    My expertise spans across various technologies, enabling me to build comprehensive full-stack solutions.
  </p>
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div className="relative group p-6 rounded-2xl bg-[#1d2b36]/60 backdrop-blur-md shadow-lg transform transition duration-300 hover:scale-105">
      ...
      {/* Experience Section */}
      <section id="experience" className="max-w-6xl mx-auto px-6 py-20 bg-[#1a1f28]">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 mt-2">My professional journey and academic background that shaped my skills.</p>
          <div className="mt-6 inline-flex rounded-md bg-[#161b22]">
            <button
              onClick={() => setView('work')}
              className={`px-5 py-2 font-medium ${view === 'work' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:text-white'}`}
            >Work</button>
            <button
              onClick={() => setView('education')}
              className={`px-5 py-2 font-medium ${view === 'education' ? 'bg-blue-600 text-white' : 'text-gray-300 hover:text-white'}`}
            >Education</button>
          </div>
        </div>
        <div className="space-y-6">
  {(view==='work' ? workExperience : educationData).map((item, idx) => (
    <div key={idx} className="p-6 bg-[#0d1117] border border-gray-800 rounded-lg shadow-md">
      ...
      <section id="contact" className="bg-[#161B22] py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <a href="https://www.linkedin.com/in/liav-huli-software-cpp-c-html-javascript-css-java/" className="flex items-center gap-2 text-blue-400 hover:underline text-lg" target="_blank">
