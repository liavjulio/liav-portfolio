    ...
    <div className="bg-[#0D1117] text-white font-sans scroll-smooth">
      ...
      <section id="about" className="max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <div className="mt-8 flex justify-center gap-4 flex-wrap">
          ...
          <a
            href="#resume"
            className="bg-white text-black hover:bg-gray-200 px-5 py-2 rounded-md text-sm flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              <path d="M8 4a1 1 0 011-1h2a1 1 0 011 1v6h3l-4 4-4-4h3V4z" />
              <path d="M3 14a1 1 0 011-1h12a1 1 0 011 1v1H3v-1z" />
            </svg>
            View Resume
          </a>
        </div>
      ...
      {/* Resume Section */}
      <section id="resume" className="bg-[#0D1117] py-20 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-4">My Resume</h2>
          <p className="text-gray-400 mb-8">
            Scroll through or download the full PDF below.
          </p>
          <div className="border border-gray-700 rounded-lg overflow-hidden shadow-lg mb-6">
            <iframe
              src="/LiavHuliCV.pdf"
              className="w-full h-[600px] md:h-[800px]"
              title="Liav Huli Resume"
            />
          </div>
          <a
            href="/LiavHuliCV.pdf"
            download
            className="inline-block bg-blue-600 hover:bg-blue-500 text-white px-8 py-3 rounded-full text-sm font-medium shadow-lg transition"
          >
